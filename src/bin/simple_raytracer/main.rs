...
use hello_triangle_rust::renderer::{
    Buffer, BufferUsage, Program, RenderPass, Shader, ShaderKind, Texture, VertexAttribute,
    VertexBinding,
};
...
fn main() -> Result<()> {
    ...
    let res = Resources::from_relative_exe_path(Path::new("assets/simple_raytracer"))?;
